...
//    public Map<String,Object> getgoods(@Param("t") Map<String,String> map);
    ...
    //删除购物车id
    @Update("update shoppingcart set user_id=null where cart_id=#{t.cart_id}")
    public int deleteid(@Param("t") Map<String,String> tea);


    //删除商品1
    @Update("update shoppingcart set goods_id1=null,totalcount=#{t.totalcount} where cart_id=#{t.cart_id}")
    public int delete1(@Param("t") Map<String,String> tea);

    //删除商品2
    @Update("update shoppingcart set goods_id2=null,totalcount=#{t.totalcount} where cart_id=#{t.cart_id}")
    public int delete2(@Param("t") Map<String,String> tea);

    //删除商品3
    @Update("update shoppingcart set goods_id3=null,totalcount=#{t.totalcount} where cart_id=#{t.cart_id}")
    public int delete3(@Param("t") Map<String,String> tea);

    //删除商品4
    @Update("update shoppingcart set goods_id4=null,totalcount=#{t.totalcount} where cart_id=#{t.cart_id}")
    public int delete4(@Param("t") Map<String,String> tea);

    //删除商品5
    @Update("update shoppingcart set goods_id5=null,totalcount=#{t.totalcount} where cart_id=#{t.cart_id}")
